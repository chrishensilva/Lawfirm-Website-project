  ...
  return (
    <>
      ...
      <header className={`main-header ${isScrolled ? 'scrolled' : ''}`} style={{
        ...
        borderBottom: isScrolled ? '1px solid var(--silver-medium)' : '1px solid rgba(229, 231, 235, 0.5)',
        ...
        <div className="container" style={styles.headerContainer}>
          ...
          <div className="header-actions" style={styles.headerActions}>
            <button 
              ...
              style={{
                ...styles.portalBtn,
                color: currentView === 'portal' ? 'var(--brand-blue)' : 'var(--text-muted)',
                borderColor: currentView === 'portal' ? 'var(--brand-blue)' : 'var(--silver-medium)',
              }}
            >
              Client Portal
            </button>
