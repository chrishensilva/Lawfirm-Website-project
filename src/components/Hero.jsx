      ...
      <div className="container" style={styles.container}>
        <div style={styles.content}>
          ...
          <h1 ref={titleRef} style={styles.title}>
            VOHARA LEGAL <br />
            <span style={styles.titleAccent}>Rooted in Tradition.<br />Defined by Excellence.</span>
          </h1>
          ...
          <div ref={statsRef} style={styles.statsContainer}>
            <div style={styles.statCard}>
              ...
              <div>
                <h4 style={styles.statNum}>20+</h4>
                <p style={styles.statLabel}>Years of Practice</p>
              </div>
            </div>
            <div style={styles.statCard}>
              <Users size={20} style={styles.statIcon} />
              <div>
                <h4 style={styles.statNum}>3+</h4>
                <p style={styles.statLabelStyle}>Senior Counsel</p>
              </div>
            </div>
            <div style={styles.statCard}>
              <ShieldCheck size={20} style={styles.statIcon} />
              <div>
                <h4 style={styles.statNum}>5k+</h4>
                <p style={styles.statLabel}>Cases Advised</p>
              </div>
            </div>
          </div>
        </div>
...
const styles = {
  ...
  overlay: {
    ...
    right: 0,
    bottom: 0,
    backgroundColor: 'rgba(10, 30, 63, 0.85)', // Deep Navy overlay for typography legibility
